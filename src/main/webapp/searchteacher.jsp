...
<body>
  	<div class="topnav">
		<ul>
		  ...
		  <li><a class="active" href="deleteclasses.jsp">DELETE CLASSES</a><li>
 ...
 <h1>SEARCH TEACHER</h1>
    ...
    <!-- Create Form -->
    <form id="form" action="ServletSearchTeacher" method="post">
        ...
        <button type="submit" value="submit">
         ...
         <%
			...
			if(teacher!=null)
			{
				out.println("TEACHER ID   : "+teacher.getTeacherId());
