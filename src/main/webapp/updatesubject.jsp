...
<body>
  	<div class="topnav">
		<ul>
		  ...
		  <li><a class="active" href="updatesubject.jsp">UPDATE SUBJECT</a><li>
		  <li><a href="deletesubject.jsp">DELETE SUBJECT</a><li>
		  <li><a href="searchsubject.jsp">SEARCH SUBJECT</a><li>
		  <li><a href="subject.jsp">SHOW SUBJECT</a><li>
 ...
 <h1>UPDATE SUBJECT</h1>
    ...
    <!-- Create Form -->
    <form id="form" action="ServletUpdateSubject" method="post">
 
        <!-- Details -->
        <div class="form-control">
            <label>Subject Id : </label>   <br>
            <input type="text" id="name" placeholder="Enter Id" name="subjectid" required><br>
        ...
        <div class="form-control">
            ...
            <!-- Input Type Text -->
            <input type="text" id="name" placeholder="Enter Name" name="subjectname" required><br>  
        </div>
