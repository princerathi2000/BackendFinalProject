...
<body>
  	<div class="topnav">
		<ul>
		  <li><a class="active" href="addclasses.jsp">ADD CLASSES</a><li>
		  ...
		  <li><a href="ServletGetAllClasses">SHOW CLASSES</a><li>
 ...
 <h1>ADD CLASS</h1>
    ...
    <!-- Create Form -->
    <form id="form" action="ServletAddClasses" method="post">
