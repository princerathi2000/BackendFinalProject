...
<body>
  	<div class="topnav">
		<ul>
		  <li><a class="active" href="addteacher.jsp">ADD TEACHER</a><li>
		  <li><a href="updateteacher.jsp">UPDATE TEACHER</a><li>
		  <li><a href="deleteteacher.jsp">DELETE TEACHER</a><li>
		  <li><a href="searchteacher.jsp">TEACHER</a><li>
		  <li><a href="teacher.jsp">SHOW TEACHER</a><li>
 ...
 <h1>ADD TEACHER</h1>
    ...
    <!-- Create Form -->
    <form id="form" action="ServletTeacherClasses" method="post">
 
        <!-- Details -->
        <div class="form-control">
            <label>Teacher Id : </label>   <br>
            <input type="text" id="name" placeholder="Enter Id" name="teacherid" required><br>
        ...
        <div class="form-control">
            ...
            <!-- Input Type Text -->
            <input type="text" id="name" placeholder="Enter Name" name="teachername" required><br>  
        </div>
