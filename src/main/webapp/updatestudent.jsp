...
<body>
  	<div class="topnav">
		<ul>
		  ...
		  <li><a class="active" href="updatestudent.jsp">UPDATE STUDENT</a><li>
 ...
 <h1>UPDATE STUDENT</h1>
    ...
    <!-- Create Form -->
    <form id="form" action="ServletUpdateStudent" method="post">
...
<!--   <div align="center">
	<form action="ServletAddStudent" method="post">  
			...
			<label>Student Id : </label>   <br>
            <input type="text" placeholder="Enter Id" name="studentid" required><br>  
